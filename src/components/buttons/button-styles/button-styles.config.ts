export const buttonTypes = {
  ...
  empty:
    ' class border-1-ui border-solid border-gray-ui before:bg-gray-ui/5 focus:ring-gray-ui/35 focus:bg-gray-ui/5 disabled:border-gray-ui/700 disabled:text-gray-ui/60 focus:ring-3',

  brand:
    'bg-yellow-ui-500 text-gray-ui before:bg-yellow-ui-400 focus:ring-yellow-ui-500/40 focus:bg-yellow-ui-400 disabled:text-gray-ui/300 disabled:bg-white/10 focus:ring-3',

  darkEmpty:
    'border-1-ui border-solid border-gray-ui/700 before:bg-gray-ui-100/5 focus:ring-gray-ui-100/25 focus:bg-gray-ui-100/5 disabled:text-gray-ui/700 focus:ring-3',
...
export const buttonGroupContainerStyle =
  'ml-2 flex border-1-ui border-gray-ui h-9 p-[3px] gap-[3px] rounded-lg items-center justify-center';
